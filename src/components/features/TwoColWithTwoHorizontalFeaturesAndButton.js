...
export default ({
  ...
  description = "Accessing a wide range of expertise not only broadens your knowledge but also provides unique solutions to challenges in your specific field. Networking opportunities on the platform allow you to build meaningful professional relationships and explore collaborative ventures with experts from different industries, fostering innovation.",
